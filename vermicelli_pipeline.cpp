...
void VermicelliPipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo, glm::u32vec2 dim) {
  ...
  configInfo.viewport.width    = static_cast<float>(dim.x);
  configInfo.viewport.height   = static_cast<float>(dim.y);
  configInfo.viewport.minDepth = 0.0f;
  configInfo.viewport.maxDepth = 1.0f;

  configInfo.scissor.offset = {0, 0};
  configInfo.scissor.extent = {dim.x, dim.y};
