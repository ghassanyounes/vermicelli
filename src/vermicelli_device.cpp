...
void VermicelliDevice::createInstance() {
  ...
  appInfo.pApplicationName   = "Vermicelli App";
  appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
  appInfo.pEngineName        = "Vermicelli";
...
void VermicelliDevice::populateDebugMessengerCreateInfo(
...
bool VermicelliDevice::checkValidationLayerSupport() {
  uint32_t layerCount;
...
bool VermicelliDevice::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices VermicelliDevice::findQueueFamilies(VkPhysicalDevice device) {
...
VkFormat VermicelliDevice::findSupportedFormat(
...
void VermicelliDevice::createBuffer(
        VkDeviceSize size,
...
void VermicelliDevice::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void VermicelliDevice::copyBufferToImage(
...
void VermicelliDevice::createImageWithInfo(
